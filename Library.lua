...
local Oversimplified={
    Theme={Bg=Color3.fromRGB(12,12,14),Border=Color3.fromRGB(45,45,50),Text=Color3.fromRGB(240,240,245),Active=Color3.fromRGB(255,255,255),Inactive=Color3.fromRGB(20,20,24),SliderBg=Color3.fromRGB(24,24,28),DarkerBg=Color3.fromRGB(8,8,10)}
}
...
function Oversimplified:CreateWindow(tTxt, keyStr)
    ...
    local Ti=Instance.new("TextLabel",MF) Ti.Size=UDim2.new(1,-64,0,30) Ti.Position=UDim2.new(0,3,0,0) Ti.BackgroundTransparency=1 Ti.Text="  "..tTxt Ti.TextColor3=Theme.Active Ti.Font=Enum.Font.GothamBold Ti.TextSize=14 Ti.TextXAlignment=Enum.TextXAlignment.Left ApplyGlow(Ti)
    ...
    local NameLbl=Instance.new("TextLabel",ProfFrame) NameLbl.Size=UDim2.new(1,-44,1,0) NameLbl.Position=UDim2.new(0,38,0,0) NameLbl.BackgroundTransparency=1 NameLbl.Text=game.Players.LocalPlayer.DisplayName NameLbl.TextColor3=Theme.Text NameLbl.Font=Enum.Font.GothamBold NameLbl.TextSize=11 NameLbl.TextXAlignment=Enum.TextXAlignment.Left NameLbl.TextTruncate=Enum.TextTruncate.AtEnd ApplyGlow(NameLbl)
    ...
    if keyStr and keyStr ~= "" then
        ...
        local KTitle=Instance.new("TextLabel",KF) KTitle.Size=UDim2.new(1,-64,0,30) KTitle.Position=UDim2.new(0,3,0,0) KTitle.BackgroundTransparency=1 KTitle.Text="  "..tTxt.." - Key System" KTitle.TextColor3=Theme.Active KTitle.Font=Enum.Font.GothamBold KTitle.TextSize=14 KTitle.TextXAlignment=Enum.TextXAlignment.Left ApplyGlow(KTitle)
        ...
        local KBtnTxt=Instance.new("TextLabel",KBtn) KBtnTxt.Size=UDim2.new(1,0,1,0) KBtnTxt.BackgroundTransparency=1 KBtnTxt.Text="Submit Key" KBtnTxt.TextColor3=Theme.Text KBtnTxt.Font=Enum.Font.GothamBold KBtnTxt.TextSize=13 ApplyGlow(KBtnTxt)
    ...
    mkMac(MF, Color3.fromRGB(255,189,68), -41, function() -- Yellow
    ...
    mkMac(MF, Color3.fromRGB(255,96,92), -20, function() SetUIVisible(false) end) -- Red
