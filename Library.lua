...
function Oversimplified:CreateWindow(tTxt, arg2, arg3)
    ...
    if keyStr and keyStr ~= "" then
        ...
        KBtn.MouseButton1Click:Connect(function()
            TS:Create(KBtn,TweenInfo.new(0.1),{BackgroundColor3=tColor}):Play() TS:Create(KBtnTxt,TweenInfo.new(0.1),{TextColor3=Theme.Bg}):Play() task.wait(0.1) TS:Create(KBtn,TweenInfo.new(0.1),{BackgroundColor3=Theme.Inactive}):Play() TS:Create(KBtnTxt,TweenInfo.new(0.1),{TextColor3=Theme.Text}):Play()
        ...
        mkMac(KF, Color3.fromRGB(255,189,68), -41, function()
            ...
            KInfo.Visible, KInput.Visible, KBtn.Visible, KD.Visible = not isKeyMin, not isKeyMin, not isKeyMin, not isKeyMin
        end)
    ...
    mkMac(MF, Color3.fromRGB(255,189,68), -41, function() -- Yellow Hub (Minimize)
        ...
        ProfFrame.Visible, VD.Visible, TC.Visible, CC.Visible, D.Visible = not isHubMin, not isHubMin, not isHubMin, not isHubMin, not isHubMin
    end)
    ...
    function WO:CreateTab(tN)
        ...
        function E:CreateParagraph(ti,de,tC,dC)
            ...
            local LT=Instance.new("TextLabel",C) LT.Size=UDim2.new(1,-20,0,20) LT.Position=UDim2.new(0,10,0,5) LT.BackgroundTransparency=1 LT.Text=ti LT.TextColor3=tC or tColor LT.Font=Enum.Font.GothamBold LT.TextSize=13 LT.TextXAlignment=Enum.TextXAlignment.Left ApplyW(LT)
        ...
        function E:CreateLabel(tx,tC)
            local Lb=Instance.new("TextLabel",TSc) eO=eO+1 Lb.LayoutOrder=eO Lb.Size=UDim2.new(1,-14,0,25) Lb.BackgroundTransparency=1 Lb.TextColor3=tC or tColor Lb.Font=Enum.Font.GothamBold Lb.TextSize=13 Lb.TextXAlignment=Enum.TextXAlignment.Left Lb.Text=tx ApplyW(Lb)
        ...
        function E:CreateButton(tx,cb)
            ...
            local Lb=Instance.new("TextLabel",B) Lb.Size=UDim2.new(1,0,1,0) Lb.BackgroundTransparency=1 Lb.Text=tx Lb.TextColor3=Theme.Text Lb.Font=Enum.Font.GothamBold Lb.TextSize=13 ApplyW(Lb)
            B.MouseButton1Click:Connect(function() TS:Create(B,TweenInfo.new(0.1),{BackgroundColor3=tColor}):Play() TS:Create(Lb,TweenInfo.new(0.1),{TextColor3=Theme.Bg}):Play() task.wait(0.1) TS:Create(B,TweenInfo.new(0.1),{BackgroundColor3=Theme.Inactive}):Play() TS:Create(Lb,TweenInfo.new(0.1),{TextColor3=Theme.Text}):Play() cb() end)
        ...
        function E:CreateSlider(tx,mn,mx,df,cb)
            ...
            SB.InputBegan:Connect(function(i) if i.UserInputType==Enum.UserInputType.MouseButton1 or i.UserInputType==Enum.UserInputType.Touch then dg=true us(i) end end) UIS.InputEnded:Connect(function(i) if i.UserInputType==Enum.UserInputType.MouseButton1 or i.UserInputType==Enum.UserInputType.Touch then dg=false end end) UIS.InputChanged:Connect(function(i) if dg and (i.UserInputType==Enum.UserInputType.MouseMovement or i.UserInputType==Enum.UserInputType.Touch) then us(i) end end)
        ...
        function E:CreateKeybind(tx,dk,cb)
            ...
            local Txt=Instance.new("TextLabel",BB) Txt.Size=UDim2.new(1,0,1,0) Txt.BackgroundTransparency=1 Txt.Text=startText Txt.TextColor3=tColor Txt.Font=Enum.Font.GothamBold Txt.TextSize=12 ApplyW(Txt)
        ...
        function E:CreateColorPicker(tx,dc,cb)
            ...
            local sUpds={} local function cCS(cN,dV,tC)
                ...
                sB.InputBegan:Connect(function(i) if i.UserInputType==Enum.UserInputType.MouseButton1 or i.UserInputType==Enum.UserInputType.Touch then dg=true sU(i) end end) UIS.InputEnded:Connect(function(i) if i.UserInputType==Enum.UserInputType.MouseButton1 or i.UserInputType==Enum.UserInputType.Touch then dg=false end end) UIS.InputChanged:Connect(function(i) if dg and (i.UserInputType==Enum.UserInputType.MouseMovement or i.UserInputType==Enum.UserInputType.Touch) then sU(i) end end)
