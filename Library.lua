...
local function MakeDraggable(f) 
    ...
    UIS.InputChanged:Connect(function(i) 
        if i==di and d then 
            local dl=i.Position-ds; f.Position=UDim2.new(sp.X.Scale,sp.X.Offset+dl.X,sp.Y.Scale,sp.Y.Offset+dl.Y) 
        end 
    end) 
end
...
function Oversimplified:CreateWindow(tTxt, keyStr)
    if CG:FindFirstChild("OS_UI") then CG:FindFirstChild("OS_UI"):Destroy() end
    ...
    -- Absolute positioning fixes the minimize bug completely
    ...
    local function SetUIVisible(state)
        ...
        if iv then FadeUI(tUI,false,0); tUI.Visible=true; FadeUI(tUI,true,0.3)
        else FadeUI(tUI,false,0.3); task.delay(0.3,function() tUI.Visible=false end) end
    ...
    function WO:CreateTab(tN)
        ...
        function E:CreateParagraph(ti,de)
            ...
            local LT=Instance.new("TextLabel",C); LT.Size=UDim2.new(1,-20,0,20); LT.Position=UDim2.new(0,10,0,5); LT.BackgroundTransparency=1; LT.Text=ti; LT.TextColor3=Theme.Active; LT.Font=Enum.Font.GothamBold; LT.TextSize=13; LT.TextXAlignment=Enum.TextXAlignment.Left
            local LD=Instance.new("TextLabel",C); LD.Size=UDim2.new(1,-20,0,20); LD.Position=UDim2.new(0,10,0,25); LD.BackgroundTransparency=1; LD.Text=de; LD.TextColor3=Theme.Text; LD.Font=Enum.Font.Gotham; LD.TextSize=12; LD.TextXAlignment=Enum.TextXAlignment.Left; LD.TextWrapped=true
            local PO={}; function PO:Set(t,d) if t then LT.Text=t end; if d then LD.Text=d end; end; return PO
        end
        function E:CreateLabel(tx)
            local Lb=Instance.new("TextLabel",TSc); eO=eO+1; Lb.LayoutOrder=eO; Lb.Size=UDim2.new(1,-14,0,25); Lb.BackgroundTransparency=1; Lb.TextColor3=Theme.Active; Lb.Font=Enum.Font.GothamBold; Lb.TextSize=13; Lb.TextXAlignment=Enum.TextXAlignment.Left; Lb.Text=tx
            local LO={}; function LO:Set(t) if t then Lb.Text=t end; end; return LO
        end
        function E:CreateButton(tx,cb)
            ...
            local Lb=Instance.new("TextLabel",B); Lb.Size=UDim2.new(1,0,1,0); Lb.BackgroundTransparency=1; Lb.Text=tx; Lb.TextColor3=Theme.Text; Lb.Font=Enum.Font.GothamBold; Lb.TextSize=13
        ...
        function E:CreateToggle(tx,df,cb)
            ...
            local Lb=Instance.new("TextLabel",C); Lb.Size=UDim2.new(1,-60,1,0); Lb.Position=UDim2.new(0,10,0,0); Lb.BackgroundTransparency=1; Lb.Text=tx; Lb.TextColor3=Theme.Text; Lb.Font=Enum.Font.GothamBold; Lb.TextSize=13; Lb.TextXAlignment=Enum.TextXAlignment.Left
        ...
        function E:CreateSlider(tx,mn,mx,df,cb)
            local C=Instance.new("Frame",TSc); eO=eO+1; C.LayoutOrder=eO; C.Size=UDim2.new(1,-14,0,50); C.BackgroundColor3=Theme.Bg; Instance.new("UICorner",C).CornerRadius=UDim.new(0,4); Instance.new("UIStroke",C).Color=Theme.Border; C.UIStroke.ApplyStrokeMode=Enum.ApplyStrokeMode.Border
            local Lb=Instance.new("TextLabel",C); Lb.Size=UDim2.new(1,-20,0,20); Lb.Position=UDim2.new(0,10,0,5); Lb.BackgroundTransparency=1; Lb.Text=tx; Lb.TextColor3=Theme.Text; Lb.Font=Enum.Font.GothamBold; Lb.TextSize=13; Lb.TextXAlignment=Enum.TextXAlignment.Left
            local VL=Instance.new("TextLabel",C); VL.Size=UDim2.new(0,50,0,20); VL.Position=UDim2.new(1,-60,0,5); VL.BackgroundTransparency=1; VL.Text=tostring(df); VL.TextColor3=Theme.Text; VL.Font=Enum.Font.GothamBold; VL.TextSize=13; VL.TextXAlignment=Enum.TextXAlignment.Right
        ...
        function E:CreateInput(tx,pl,cb)
            ...
            local Lb=Instance.new("TextLabel",C); Lb.Size=UDim2.new(0.5,0,1,0); Lb.Position=UDim2.new(0,10,0,0); Lb.BackgroundTransparency=1; Lb.Text=tx; Lb.TextColor3=Theme.Text; Lb.Font=Enum.Font.GothamBold; Lb.TextSize=13; Lb.TextXAlignment=Enum.TextXAlignment.Left
        ...
        function E:CreateKeybind(tx,dk,cb)
            ...
            local Txt=Instance.new("TextLabel",BB); Txt.Size=UDim2.new(1,0,1,0); Txt.BackgroundTransparency=1; Txt.Text=startText; Txt.TextColor3=Theme.Active; Txt.Font=Enum.Font.GothamBold; Txt.TextSize=12
        ...
        function E:CreateDropdown(tx,op,df,cb)
            ...
            local Lb=Instance.new("TextLabel",DB); Lb.Size=UDim2.new(0.5,0,1,0); Lb.Position=UDim2.new(0,10,0,0); Lb.BackgroundTransparency=1; Lb.Text=tx; Lb.TextColor3=Theme.Text; Lb.Font=Enum.Font.GothamBold; Lb.TextSize=13; Lb.TextXAlignment=Enum.TextXAlignment.Left
            local SL=Instance.new("TextLabel",DB); SL.Size=UDim2.new(0.5,-30,1,0); SL.Position=UDim2.new(0.5,0,0,0); SL.BackgroundTransparency=1; SL.Text=df; SL.TextColor3=Theme.Active; SL.Font=Enum.Font.GothamBold; SL.TextSize=12; SL.TextXAlignment=Enum.TextXAlignment.Right
        ...
        function E:CreateColorPicker(tx,dc,cb)
            ...
            local Lb=Instance.new("TextLabel",PB); Lb.Size=UDim2.new(0.5,0,1,0); Lb.Position=UDim2.new(0,10,0,0); Lb.BackgroundTransparency=1; Lb.Text=tx; Lb.TextColor3=Theme.Text; Lb.Font=Enum.Font.GothamBold; Lb.TextSize=13; Lb.TextXAlignment=Enum.TextXAlignment.Left
